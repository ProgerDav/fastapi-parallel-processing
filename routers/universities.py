...
from config.celery_tasks import get_all_universities_task, get_university_task
...
def get_universities(country: Country) -> dict:
    """
    Return the List of universities for the countries for e.g ["armenia", "india", "iran"] provided
